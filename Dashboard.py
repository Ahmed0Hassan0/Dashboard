...
cost_2022_df = pd.read_csv('Datasets/Cost_2022.csv')
cost_2023_df = pd.read_csv('Datasets/Cost_2023.csv')
cost_df = pd.concat([cost_2022_df, cost_2023_df])
cost_df['Amount'] =cost_df['Amount'].astype(float)

revenue_2022_df = pd.read_csv('Datasets/Revenue_2022.csv')
revenue_2023_df = pd.read_csv('Datasets/Revenue_2023.csv')
